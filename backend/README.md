...
## Project Structure
    ...
    ├── testapiautosetting_125114  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125114`
...
2. Clone this repo and `cd testapiautosetting_125114`
